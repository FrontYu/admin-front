    ...
    <div class="login-box">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px" class="demo-ruleForm login-container"
        ...
        <el-form-item prop="oldPass">
          <el-input type="password" v-model="ruleForm.oldPass" auto-complete="off" :placeholder="$t('login.oldPass')"></el-input>
        </el-form-item>
        <el-form-item prop="newPass">
          <el-input type="password" v-model="ruleForm.newPass" auto-complete="off" :placeholder="$t('login.newPass')"></el-input>
        </el-form-item>
        <el-form-item prop="checkPass">
          <el-input type="password" v-model="ruleForm.checkPass" auto-complete="off" :placeholder="$t('login.checkPass')"></el-input>
        </el-form-item>
    ...
    data() {
      ...
      return {
        ...
        rules: {
          oldPass: [{
            required: true,
            message: this.$t('login.inputOldPass'),
            trigger: 'blur'
          }],
          newPass: [{
