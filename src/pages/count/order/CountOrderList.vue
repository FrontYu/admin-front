    ...
    <el-card style="margin-top: 20px;">
      ...
      <el-form :inline="true" :model="searchForm" ref="searchForm">
        ...
        <el-form-item label="支付方式">
          <el-select v-model="searchForm.pay_way" placeholder="请选择" @change="changeSearch">
        ...
        <el-form-item label="产品">
          <el-select v-model="searchForm.product_class" filterable placeholder="请选择" @change="changeSearch">
            <el-option v-for="item in productData" :key="item.product_class" :label="item.product_name"
              :value="item.product_class"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="下单时间">
          <el-date-picker v-model="searchForm.dateRange" type="daterange" align="right" unlink-panels
            range-separator="至" start-placeholder="订单开始日期" end-placeholder="订单结束日期" :picker-options="pickerDateOptions"
            @change="changeSearch"></el-date-picker>
        </el-form-item>
